...
// }
//
// private[oap] case class OapBitmapChunkInFiberCache(wfc:
// OapBitmapWrappedFiberCache, chunkIdx: Int) {
...
// }
//
// private[oap] case class BitmapChunkIterator(wfc:
// OapBitmapWrappedFiberCache) extends Iterator[Int] {
//
